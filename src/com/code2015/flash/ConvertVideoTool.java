package com.code2015.flash;

import java.io.File;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;
public class ConvertVideoTool {
    ...
    private static void getPath() { // 先获取当前项目路径，在获得源文件、目标文件、转换器的路径
        ...
        try {
            ...
            String currPath="C:\\inetpub\\wwwroot\\images";
            inputPath = currPath + "\\flash\\I16042811170108498.mp4";
            outputPath = currPath + "\\outputflash\\";
